      ...
      <div className="max-w-[1500px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
        {tiers.map((tier, idx) => (
          ...
          >
            ...
            {/* UPDATED: Single Unified Button pointing to the Booking Form */}
            <a 
              href={bookingUrl}
              target="_blank"
              rel="noopener noreferrer"
              className={`mt-auto w-full py-4 rounded-full font-bold uppercase tracking-widest text-xs text-center transition-all 
